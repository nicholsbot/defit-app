...
export default function CadetPlan() {
  ...
  return (
    <div className="space-y-6">
      <p className="text-muted-foreground">
        A 5-day workout schedule designed for those new to fitness or getting back into a routine. Click "Add to Log" to record a day's workout.
      </p>
