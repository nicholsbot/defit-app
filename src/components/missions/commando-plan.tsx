...
export default function CommandoPlan() {
  ...
  return (
    <div className="space-y-6">
      <p className="text-muted-foreground">
        A 5-day workout schedule designed for peak performance and elite fitness. Click "Add to Log" to record a day's workout.
      </p>
